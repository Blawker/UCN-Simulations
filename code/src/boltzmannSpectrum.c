...
Double_t fit_function(Double_t *x, Double_t *par) {
  ...
  Double_t energy_max = 45e-9; // in eV
  Double_t T = 2*energy_max*e/k; // Temperature in K
...
void simulation_extraction() {
  ...
  Double_t e = 1.602e-19; // Coulomb charge in J
  Double_t upper_energy = 200e-9; // in eV
  Double_t lower_energy = 0.e-9; // in eV

  TCanvas *canvas_1 = new TCanvas("c1", "TRIGA Spectrum");

  //read the Tree generated by tree1w and fill two histograms

  //note that we use "new" to create the TFile and TTree objects !
  //because we want to keep these objects alive when we leave this function.
  TFile *f = new TFile("../output/Beamline/merge/beamline_surface_TRIGA_merge.root");
  //TFile *f = new TFile("../../../Kassiopeia/Kasper_build/config/Kassiopeia/UCN_Internship/Training Exercises/boltzmann_spectrum.root");
  ...
  f->GetObject("hist_final_ke", histogram);
